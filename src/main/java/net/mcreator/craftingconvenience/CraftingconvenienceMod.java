package net.mcreator.craftingconvenience;
...
@Mod("craftingconvenience")
public class CraftingconvenienceMod {
	public static final Logger LOGGER = LogManager.getLogger(CraftingconvenienceMod.class);
	public static final String MODID = "craftingconvenience";

	public CraftingconvenienceMod(FMLJavaModLoadingContext context) {
